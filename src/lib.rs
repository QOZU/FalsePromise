...
#[derive(Debug)]
pub struct FalsePromiseProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FalsePromiseProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FalsePromise processing");
    
    let mut processor = FalsePromiseProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FalsePromiseProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FalsePromiseProcessor::new(false);
